...
--
-- Oracle 19c compatibility notes:
--   - JSONB -> CLOB CHECK (col IS JSON)
--   - user_json_cardid is a regular column maintained by stored procedures
--     (Oracle 19c cannot derive virtual columns from CLOB)
--   - Oracle 21c+: replace CLOB with native JSON type and use a VIRTUAL generated column
--
...
CREATE TABLE user_table (
  ...
  user_json_object        CLOB          CHECK (user_json_object IS JSON),
