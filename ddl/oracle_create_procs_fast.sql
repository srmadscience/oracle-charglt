-- Oracle 19c PL/SQL stored procedures — fast commit mode.
...
-- For full ACID commits use oracle_create_procs_normal.sql instead.
-- For Oracle 21c+ use oracle_21c_create_procs_normal.sql / oracle_21c_create_procs_fast.sql.
